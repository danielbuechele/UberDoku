...
/***/ function(module, exports, __webpack_require__) {
	...
	React.render(React.createElement(UberDoku, null),document.getElementById("app"));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var sudoku = __webpack_require__(8);
		...
		render: function () {
			...
			return (
				React.createElement("div", null, 
					React.createElement("h1", null, "UberDoku"), 
					React.createElement(Buttons, {newPuzzle: this.newPuzzle, solvePuzzle: this.solvePuzzle, resetPuzzle: this.resetPuzzle, board: this.state.board}), 
					
						this.state.board.map(function (e,i) {
							return React.createElement(SudokuField, {onClick: _self.onClick, onChange: _self.changeNumber, board: _self.state.board, key: i, i: i, ref: i});
						})
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({displayName: "exports",
		...
		render: function () {
			...
			return (
				React.createElement("div", {className: classes, onClick: this.onClick, onKeyUp: this.onKeyUp}, 
					React.createElement("div", {className: "fieldContent"}, 
						React.createElement(NumberPicker, {onChange: this.props.onChange, board: this.props.board, i: this.props.i}), 
						React.createElement("div", {className: "fieldTable"}, 
							React.createElement("span", {className: "fieldCell"}, value)
						)
					)
				)
			);
		...
		render: function () {
			...
			return (
				React.createElement("div", {className: "buttons"}, 
					React.createElement("a", {className: "button green", onClick: this.props.newPuzzle}, "New"), 
					React.createElement("a", {className: "button yellow", onClick: this.props.solvePuzzle}, "Solve"), 
					React.createElement("a", {className: "button red", onClick: this.props.resetPuzzle}, "Reset"), 
			...
			return (
				React.createElement("div", {className: "numberPicker"}, 
					[1,2,3,4,5,6,7,8,9].map(function (i) {
						return (
							React.createElement("div", {className: "numberPickerItem", onClick: _self.onClick}, 
								React.createElement("span", {className: "numberPickerItemInner"}, i)
							)
						);
					})
				)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		module.hot.accept("!!/Users/dani/UberDoku/node_modules/css-loader/index.js!/Users/dani/UberDoku/node_modules/autoprefixer-loader/index.js!/Users/dani/UberDoku/node_modules/less-loader/index.js!/Users/dani/UberDoku/less/Buttons.less", function() {
			var newContent = require("!!/Users/dani/UberDoku/node_modules/css-loader/index.js!/Users/dani/UberDoku/node_modules/autoprefixer-loader/index.js!/Users/dani/UberDoku/node_modules/less-loader/index.js!/Users/dani/UberDoku/less/Buttons.less");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
		// When the module is disposed, remove the <style> tags
...
/***/ function(module, exports, __webpack_require__) {
	...
	if ("production" !== process.env.NODE_ENV) {
	  React.addons.Perf = __webpack_require__(96);
